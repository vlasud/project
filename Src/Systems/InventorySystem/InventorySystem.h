...
//  * конец сессии (subscribeEnd) — REPLACE снимка вещей в `player_items` по
//    account_id одним throwQuery: удаляем все строки аккаунта и вставляем текущие
//    ненулевые. Пишем синхронно на конце сессии (accountId ещё валиден), НЕ при
//    каждом изменении в сессии (для дев-выдачи это ок; будущая покупка должна
//    форсить сохранение или перейти на write-through — см. Docs/Inventory.md).
//
