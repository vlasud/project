...
//  * «занято» = любая машина физически в радиусе точки (anyVehicleNear); при
//    пере-спавне СВОЯ машина из проверки исключается (можно встать на её же точку);
//    все точки заняты — отказ (существующие машины не трогаем);
